...
static void do_q(struct fp_img_dev *dev)
{
	...
	unsigned char q2[0x0a] = { 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x55, 0x00, 0x08, 0x00 };  // SetParam
	swap (dev, q1, 0x07);
	swap (dev, q2, 0x0a);
}
...
{
	unsigned char b1[0x08] = { 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x14, 0x00 };  // GetParam
	unsigned char b2[0x06] = { 0x00, 0x00, 0x00, 0x00, 0x0E, 0x00 };  // AbortPrint
	unsigned char b3[0x08] = { 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x11, 0x00 }; // GetParam
	unsigned char b4[0x0a] = { 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x62, 0x00, 0x32, 0x00 }; // SetParam
	swap (dev, b1, 0x08);
	swap (dev, b2, 0x06);
...
{
	unsigned char b1[0x06] = { 0x00, 0x00, 0x00, 0x00, 0x06, 0x00 };  // GetConfiguration
	unsigned char b2[0x08] = { 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x2E, 0x00 }; // GetParam
	unsigned char b3[0x07] = { 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00 }; // GetVersion
	unsigned char b4[0x06] = { 0x00, 0x00, 0x00, 0x00, 0x0E, 0x00 }; // AbortPrint
	unsigned char b5[0x0a] = { 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x55, 0x00, 0x08, 0x00 }; // SetParam
	unsigned char b6[0x0a] = { 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x55, 0x00, 0x08, 0x00 }; // SetParam
	unsigned char b7[0x0a] = { 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x55, 0x00, 0x08, 0x00 }; // SetParam
	unsigned char b8[0x08] = { 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x14, 0x00 }; // GetParam
	unsigned char b9[0x08] = { 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x11, 0x00 }; // GetParam
	unsigned char ba[0x0a] = { 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x62, 0x00, 0x32, 0x00 }; // SetParam
